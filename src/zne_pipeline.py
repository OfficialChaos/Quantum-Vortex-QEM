...
NOTE: This module is a standalone demonstration pipeline. The paper's
full experimental results (153,600 runs) were generated by
run_experiments_v4.py, which uses circuit folding (gate repetition)
for noise amplification rather than the multiplicative scaling used
here. For exact reproduction of paper results, use run_experiments_v4.py.
"""
